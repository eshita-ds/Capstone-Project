...
# File Name: submit_ft_eval.py
# File Usage:
#     This file is used to submit the finetuning evaluation job to Kaggle.
#     The evaluation job is submitted using the Kaggle API.
...
def main():
    notebook_folder = "/opt/airflow/dags/kaggle-ft-eval"
    result = subprocess.run(
    ...
    wait_for_kaggle_kernel("eshitagupta151991/airflow-llama-ft-eval-v2", 30)
